...
# Path manipulation
function joinpathh5(a::ByteString, b::ByteString)
    isempty(a) && return b
    isempty(b) && return a
...
joinpathh5(a::ByteString, b::ByteString, c::ByteString) = joinpathh5(joinpathh5(a, b), c)
...
function setindex!(p::HDF5Properties, val, name::ByteString)
